                    ...
                    <div class="col-md-12">
                        ...
                        if($row1['status']==1){
                         ...
                         ?>
                                ...
                                <td>
                                    <a href="?delete&id=<?php echo $row1['id'];?>" onclick="return confirm('Are You Sure To Delete <?php echo $row1['name'];?>');"><i class="fa fa-trash" style="color:red;font-size: 20px"></i></a>
                                  </td>
