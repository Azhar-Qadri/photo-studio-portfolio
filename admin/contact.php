                    ...
                    <div class="col-md-12">
                        ...
                        if($row['status']==1){
                         ...
                         ?>
                                  ...
                                  <td>
                                    <a href="?delete&id=<?php echo $row['id'];?>" onclick="return confirm('Are You Sure To Delete <?php echo $row['name'];?>');"><i class="fa fa-trash" style="color:red;font-size: 20px; margin-left: 10px"></i></a>
                                  </td>
